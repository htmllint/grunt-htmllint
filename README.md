...
**
It also goes into the process of using `npm` and `node`.  
If you haven't installed NodeJS before, now is the time.   
Go to [NodeJS](http://nodejs.org/) (linked from the Grunt site) to download.  
